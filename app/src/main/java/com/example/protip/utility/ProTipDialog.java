...
/**
 * Class used to open dialog windows across app
 */
public class ProTipDialog {

    /**
     * Static function which opens dialog window
     *
     * @param title {@link String} the title
     * @param text {@link String} the text
     * @param dialogType {@link DialogType} the type of dilaog to be opened
     * @param activity {@link AppCompatActivity} the activity in which is dialog being open
     */
    public static void openDialog(final String title,
                                  final String text,
